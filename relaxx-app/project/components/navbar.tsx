    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:block">
          ...
          <li><Link href="/" className="text-black hover:text-black/70">Home</Link></li>
            <li><Link href="#about" className="text-black hover:text-black/70">Over de Stoel </Link></li>
            <li><Link href="/services" className="text-black hover:text-black/70">Ontspan met RelaxX </Link></li>
      ...
      {isMenuOpen && (
        ...
        <ul className="flex flex-col items-center text-center space-y-3">
            ...
            <li><Link href="/b2b" onClick={closeMenu} className="text-black hover:text-black/70">Zakelijk</Link></li>
